 ...
 * Copyright (c) 2009-2011 by UTM_Ti, Inc. All Rights Reserved.
...
//@interface UTM_TiObject : NSObject
//@end

@interface UTM_TiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UTM_TiObject class]])
		{
			for (NSString *key in [[(UTM_TiObject*)o modules] allKeys])
			{
