...
// in simulator we redefine to format for UTM_Ti Developer console
...
{\
	NSString * exceptionName = [@"org.utm_ti." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.utm_ti";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIUTM_TiNativeItemNone = -1, 
	UIUTM_TiNativeItemSpinner = -2,
	UIUTM_TiNativeItemProgressBar = -3,
	
	UIUTM_TiNativeItemSlider = -4,
	UIUTM_TiNativeItemSwitch = -5,
	UIUTM_TiNativeItemMultiButton = -6,
	UIUTM_TiNativeItemSegmented = -7,
	
	UIUTM_TiNativeItemTextView = -8,
	UIUTM_TiNativeItemTextField = -9,
	UIUTM_TiNativeItemSearchBar = -10,
	
	UIUTM_TiNativeItemPicker = -11,
	UIUTM_TiNativeItemDatePicker = -12,
	
	UIUTM_TiNativeItemInfoLight = -13,
	UIUTM_TiNativeItemInfoDark = -14,
	
	UIUTM_TiNativeItemDisclosure = -15,
	
	UIUTM_TiNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all UTM_Ti instances of
