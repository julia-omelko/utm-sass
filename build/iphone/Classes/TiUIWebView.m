...
static NSString * const kUTM_TiJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_utm_tiInjection
{
	...
	[html appendString:kUTM_TiJavascript];
...
{
	// attempt to make well-formed HTML and inject in our UTM_Ti bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _utm_tiInjection]];
