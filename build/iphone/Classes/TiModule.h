...
/**
 The base class for all UTM_Ti modules
 */
...
/**
 UTM_Ti Platform calls this method on startup.
 */
-(void)startup;

/**
 UTM_Ti Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 UTM_Ti Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 UTM_Ti Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 UTM_Ti Platform calls this method on resume.
 @param sender The sender of the event.
 */
