...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by adebonis",
		deployType: "development",
		description: "not specified",
		guid: "cb50d5ff-32d1-4bf4-a748-6dbe0f5a06e2",
		id: "com.youthisme.mobile",
		name: "UTM_Ti",
		names: {"es": "Titanio"},
		publisher: "adebonis",
		url: "http://youthisme.com",
		version: "1.0"
	},
	has: {
...
p.setString("acs-api-key-production","F80xpsGgm2Yyf2cPLtXumHzoeVi1j1bP");
p.setString("acs-api-key-development","sInlDKJGeaPrtdf5L8c3xsCZh3F6I7BB");
p.setString("acs-oauth-secret-development","llJKCFisyfrs20z5SnKct56cep0vaWVH");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","XbPKERaMoJfff62gYF9kCfxO7t7DYIiv");
p.setString("acs-oauth-key-development","D8emSitkv0UekXWKIETz3xQDg85kFk9g");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","GgRLC2knR79k4Bmx8PaUKDZQRXQNdEKZ");
});
